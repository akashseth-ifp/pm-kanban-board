...
export default function AuthPage() {
  ...
  const { mutateAsync: emailSignInMutation, isPending: emailSignInLoading } =
    useMutation({
  ...
  const { mutateAsync: emailSignUpMutation, isPending: emailSignUpLoading } =
    useMutation({
      mutationFn: (data: FormData) =>
        emailSignUpAPI(data.email, data.password, data.name || ""),
      onSuccess: onAuthSuccessHandler,
      onError: (error) => {
  ...
  const { mutateAsync: githubSignInMutation, isPending: githubSignInLoading } =
    useMutation({
